  ...
  <Layout title="Segera Hadir">
    ...
    <div className="relative z-10 py-6 space-y-16 lg:space-y-32 text-gray-900">
      <div className="text-center space-y-10">
        ...
        <h1 className="text-7xl lg:text-9xl font-extrabold">ISBI SINGKAWANG</h1>
        <p className="text-xl lg:text-2xl tracking-wide mx-10 lg:max-w-xl lg:mx-auto">
          Kampus Multi Etnis, Area Perbatasan, Social Entrepreneurship
        </p>
      </div>
      <form className="relative z-10 mx-10 lg:max-w-xl lg:mx-auto">
        <input
          type="text"
          placeholder="sekretariat@isbisingkawang.ac.id"
    ...
    <div className="absolute bottom-5">
      <ul className="flex space-x-3">
        <li>
          <Link href="https://isbisingkawang.ac.id">
